...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            //admin
            ['name' => 'Appollo Admin', 'email' => 'admin@appollo.com', 'uType' => '1',  'password' => bcrypt('appolloAdmin'), 'background' => 'Educational Technology Associate for Instructional Technology', 'interests' => 'Education, Community Building, Communications, Networking & Collaboration', 'company' => 'De La Salle - College of Saint Benilde', 'profilepic' => 'default.jpg'],
            // Sir Jen
